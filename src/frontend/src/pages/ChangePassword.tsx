        ...
        <div className="w-full max-w-sm animate-fade-in-up">
          <div className="flex flex-col items-center mb-10">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4"
              ...
              <KeyRound className="w-7 h-7" style={{ color: 'oklch(0.72 0.16 195)' }} />
            </div>
            <h1 className="text-xl font-semibold">Change Password</h1>
            <p className="text-xs text-muted-foreground mt-1">Required before first use</p>
          </div>

          <div className="glass-card p-8">
            <div className="p-3 rounded-lg mb-6 text-xs"
              style={{ background: 'oklch(0.72 0.18 60 / 0.08)', border: '1px solid oklch(0.72 0.18 60 / 0.2)', color: 'oklch(0.72 0.18 60)' }}>
