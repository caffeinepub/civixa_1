...
export function AdminDatabase() {
  const { locations, services, reports, addLocation, deleteLocation } =
    useData();
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Manage location databases and system backups
                </p>
              </div>
            </div>
            <Button
          ...
          <div className="glass-card p-5 mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <SysInfo
                ...
                value={systemInfo.totalDatabases.toString()}
              />
              <SysInfo
              ...
              <SysInfo
                ...
                value={systemInfo.totalServices.toString()}
              />
              <SysInfo
                label="Total Reports"
                value={systemInfo.totalReports.toString()}
              />
            </div>
          </div>
                  ...
                  <div key={loc.id} className="glass-card p-5">
                    ...
                    {lastBackup[loc.id] && (
                      <p className="text-xs text-muted-foreground mb-3">
                        Last backup:{" "}
                        <span className="font-mono">{lastBackup[loc.id]}</span>
                      </p>
                    )}
          ...
          <AlertDialogContent className="glass-card-solid border-white/15">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                <strong>
                  {locations.find((l) => l.id === deleteId)?.name}
                </strong>{" "}
