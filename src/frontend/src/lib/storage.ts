...
export function addAuditLog(
  log: Omit<CivixaAuditLog, "id" | "createdAt">,
): void {
...
export function seedIfEmpty(): void {
  ...
  const storedVersion = Number.parseInt(
    localStorage.getItem(KEYS.SEED_VERSION) ?? "0",
    10,
  );
  if (getLocations().length > 0 && storedVersion >= CURRENT_SEED_VERSION)
    return;
  ...
  const coreServiceTemplates: Array<{ name: string; impact: string }> = [
    {
      ...
      impact: "Residential & Commercial power distribution",
    },
    {
      name: "Government Offices",
      impact: "Municipal, district and state offices",
    },
    ...
    { name: "Internet – Airtel", impact: "Broadband & fiber connectivity" },
    {
      ...
      impact: "Broadband & fiber connectivity",
    },
    { name: "Internet – Hathway", impact: "Broadband & fiber connectivity" },
    {
      name: "Internet – SITI Networks",
      impact: "Broadband & fiber connectivity",
    },
    { name: "Internet – Excitel", impact: "Broadband & fiber connectivity" },
    {
      name: "Internet – YOU Broadband",
      impact: "Broadband & fiber connectivity",
    },
    {
      name: "Internet – TATA Play Fiber",
      impact: "Broadband & fiber connectivity",
    },
  ...
  const reports: CivixaReport[] = [
    {
      ...
      area: "Adyar",
      description:
        "Power has been flickering for the past 2 hours. Several appliances damaged.",
    ...
    },
    {
      ...
      area: "T. Nagar",
      description:
        "Large pothole on main road causing accidents. No signage or barriers.",
      contactEmail: "mod@civixa.local",
      status: "pending",
    ...
    },
    {
      ...
      area: "Velachery",
      description:
        "Complete power outage since morning. No response from local TNEB office.",
  ...
  const auditLogs: CivixaAuditLog[] = [
    {
      id: "log-1",
      action: "Report approved: Electricity outage in Velachery",
      performedBy: "mod-1",
      performedByName: "Chennai Mod",
      locationId: "loc-1",
      createdAt: new Date(seedNow.getTime() - 10 * 60 * 1000).toISOString(),
    },
    {
      id: "log-2",
      action: "Service status updated: Electricity Supply → Warning",
      performedBy: "mod-1",
      performedByName: "Chennai Mod",
      locationId: "loc-1",
      createdAt: new Date(seedNow.getTime() - 9 * 60 * 1000).toISOString(),
    },
  ];
